...
public class WebsocketRouter {
	...
	private static String ENGINE = "inikas";
	...
	public static void runEngine(String talk, final play.mvc.WebSocket.Out<String> out){
		
		WebsocketService.talk(ENGINE, talk, out);
	}
